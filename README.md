...
Once you've completed Phase 1, to run the app, you need to have the USB drivers for your phone based on your manufacturer. A quick online search for `USB drivers Android <device name>` should work. On your device, make sure you have [USB Debugging](http://developer.android.com/tools/device.html) enabled under Settings > Developer Options. To get the developer options setting go to Settings > About phone and tap Build Number 7 times (I'm not kidding - this is for real!).
